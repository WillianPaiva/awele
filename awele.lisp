...
=======
        (player north)) 
    (reset-game)
    (loop while (not (game-over player board))
          do (progn
               (print-board board)
               (if (= player north)
               ...
               (setq player (opponent player))))
    t))
>>>>>>> be563e4f032e40aeb432ef9fb4edec0c4b9456e6
...
=======
  ...
  (defun game-over (player board)
    (if (or (or (> *north-score* 24) (> *south-score* 24)) (endp (valid-list player board)))
      t
      nil)
    )
>>>>>>> be563e4f032e40aeb432ef9fb4edec0c4b9456e6
